...
$db = "69b6afd6003b7f253881"

Write-Host "Creating collections and attributes..."

appwrite databases create-collection --database-id $db --collection-id "user_profiles" --name "user_profiles" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "artisan_profiles" --name "artisan_profiles" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "jobs" --name "jobs" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "bids" --name "bids" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "bookings" --name "bookings" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "chat_messages" --name "chat_messages" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "reviews" --name "reviews" --document-security true
...
appwrite databases create-collection --database-id $db --collection-id "credits" --name "credits" --document-security true
...
Write-Host "Waiting 15 seconds for attributes to be properly registered before creating indexes..."
